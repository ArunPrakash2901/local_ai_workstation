...
AUTONOMY_LEVELS = {
    "LEVEL_0_CAPTURE_ONLY",
    "LEVEL_1_VALIDATE_AND_SUMMARIZE",
    "LEVEL_2_AUTO_REPAIR_PACKET",
    "LEVEL_3_PATCH_PROPOSAL",
    "LEVEL_4_APPLY_WITHIN_ALLOWED_SCOPE",
    "LEVEL_5_TEST_AND_REPAIR_LOOP",
    "LEVEL_6_PREPARE_COMMIT_ONLY",
    "LEVEL_7_COMMIT_REQUIRES_APPROVAL",
    "LEVEL_8_PUSH_MERGE_REQUIRES_APPROVAL",
}
