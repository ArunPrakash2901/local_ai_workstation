...
AST_CHECKS = (
    ...
    ROOT / "scripts" / "product_design_managed_runtime.py",
    ...
    ROOT / "scripts" / "ws_product_design_runtime_status.py",
    ROOT / "scripts" / "ws_product_design_runtime_start.py",
    ROOT / "scripts" / "ws_product_design_runtime_stop.py",
    ...
    ROOT / "scripts" / "test_product_design_managed_runtime.py",
    ...
    ROOT / "scripts" / "test_runtime_lane.py",
    ROOT / "scripts" / "test_exchange_lane.py",
    ROOT / "scripts" / "test_execution_lane.py",
    ...
    ROOT / "runtime_lane" / "tools" / "runtime_session.py",
    ROOT / "runtime_lane" / "tools" / "audit_runtime_lane.py",
    ROOT / "exchange_lane" / "tools" / "exchange_packet.py",
    ROOT / "exchange_lane" / "tools" / "exchange_command.py",
    ROOT / "exchange_lane" / "tools" / "audit_exchange_lane.py",
    ROOT / "execution_lane" / "tools" / "execution_command.py",
    ROOT / "execution_lane" / "tools" / "audit_execution_lane.py",
...
CHECK_STEPS = (
    ...
    ("Product design managed runtime validation", ROOT / "scripts" / "test_product_design_managed_runtime.py"),
    ...
    ("Exchange Lane validation", ROOT / "scripts" / "test_exchange_lane.py"),
    ("Execution Lane validation", ROOT / "scripts" / "test_execution_lane.py"),
